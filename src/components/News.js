...
export default class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `${this.capitalizeFirstLetter(this.props.category)} - JustNews`;
  }
  ...
  render() {
    return (
      <div className="container my-3 ">
        <h1 className="text-center mx-1">JustNews - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
